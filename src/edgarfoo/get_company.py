...
ATTR_XPATHS = (
    ...
    (
        ...
        "/companyFilings/companyInfo/businessAddress/city/text()",
    ),
    (
        "business_address_state",
        "/companyFilings/companyInfo/businessAddress/state/text()",
    ),
    (
        "business_address_zipcode",
        "/companyFilings/companyInfo/businessAddress/zipCode/text()",
    ),
